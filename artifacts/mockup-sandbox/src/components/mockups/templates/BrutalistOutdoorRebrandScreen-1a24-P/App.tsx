...
type HotStyle = React.CSSProperties & { '--hot'?: string };
      ...
      <div className="flex flex-col h-full justify-between">
        <div>
          ...
          <h2 className="font-black leading-[0.92] tracking-tight text-[clamp(2rem,5.5vw,5rem)]">
            ...
            <br />
            <span className="hotword inline-block px-2 -ml-2" style={{ '--hot': hot } as HotStyle}>
              CAIRN.
            </span>
          </h2>
        </div>
      ...
      <div className="flex flex-col h-full justify-between">
        <div className="flex items-end justify-between mb-6">
          <h2 className="font-black leading-[0.9] tracking-tight text-[clamp(2rem,4.5vw,4rem)]">
            ...
            <span className="hotword px-1 -ml-1" style={{ '--hot': hot } as HotStyle}>NOTHING ELSE.</span>
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 border-2 border-black">
          {[
            ...
            <div key={n} className="hotcell border-black border-r-2 last:border-r-0 [&:nth-child(2)]:max-md:border-r-0 max-md:[&:nth-child(-n+2)]:border-b-2 p-4 flex flex-col gap-6 cursor-default" style={{ '--hot': hot } as HotStyle}>
      ...
      <div className="flex flex-col h-full justify-between">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 border-2 border-black flex-1">
          {[
            ...
            <div key={i} className="hotcell border-black md:border-r-2 md:last:border-r-0 max-md:border-b-2 max-md:last:border-b-0 p-6 flex flex-col justify-between cursor-default" style={{ '--hot': hot } as HotStyle}>
        ...
        <div className="flex flex-wrap items-center gap-4 mt-6">
          <span className="hotword font-black text-[clamp(1.4rem,3vw,2.4rem)] tracking-tight px-1" style={{ '--hot': hot } as HotStyle}>
      ...
      <div className="w-full max-w-6xl border-[3px] border-black bg-[#F4F1EA] flex flex-col" style={{ aspectRatio: 'auto' }}>
        ...
        <header className="grid grid-cols-[1fr_auto] border-b-[3px] border-black">
          ...
          <button
            ...
            style={{ '--hot': current.hot } as HotStyle}
          >
